"""
Django settings for SurveyPlane project.
...
# SECRET_KEY = 'django-insecure-itzq9jn+q6&y7qc!)a5gbejnfmlyu@9h2+5p80(hdreq6s1*8g'
...
WSGI_APPLICATION = 'SurveyPlane.wsgi.application'
...
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER') or '<YOUR EMAIL_HOST_USER HERE>'
